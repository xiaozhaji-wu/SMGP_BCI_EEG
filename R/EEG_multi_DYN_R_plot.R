...
for (person in persons){
  ...
  EEG_multi_path <- paste0("E:/MSPH/EEG methodology/Advanced EEG Code/EEG_multi_DYN/", person, "/R_plots")
  EEG_multi_ref_path <- paste0("E:/MSPH/EEG methodology/Advanced EEG Code/EEG_multi_ref_DYN/", person, "/R_plots")
...
write.csv(final_accuracy, "E:/MSPH/EEG methodology/Advanced EEG Code/EEG_multi_DYN/final_accuracy.csv", row.names = FALSE)