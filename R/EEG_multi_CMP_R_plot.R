...
final_accuracy <- data.frame(Person = character(),
                             SMGP = numeric(),
                             swLDA = numeric(),
                             BLDA = numeric(),
                             stringsAsFactors = FALSE)

persons <- c("K106", "K113", "K145", "K159", "K160", "K178", "K190", 
             "K107", "K114", "K172", "K184", "K185",
             "K151", "K154", "K183","K191") #"K107", "K118", "K145", "K113", "K121", "K106",
#"K111", "K112", "K114", "K151", "K160", "K172", 
#"K183", "K190", "K191". "K159", "K185", "K184",
#"K178", "K154"
...
for (person in persons){
  ...
  EEG_multi_path <- paste0("E:/MSPH/EEG methodology/Advanced EEG Code/EEG_multi_CMP/", person, "/R_plots")
  EEG_multi_ref_path <- paste0("E:/MSPH/EEG methodology/Advanced EEG Code/EEG_multi_ref_CMP/", person, "/R_plots")
  ...
  # 将结果存入表格
  final_accuracy <- rbind(final_accuracy, 
...
write.csv(final_accuracy, "E:/MSPH/EEG methodology/Advanced EEG Code/EEG_multi_CMP/final_accuracy.csv", row.names = FALSE)