...
file_path = f'E:/MSPH/EEG methodology/Advanced EEG Code/Code for GitHub/SMGP_BCI_EEG/EEG_multi_ref/{person}'
if not os.path.exists(file_path):
    os.makedirs(file_path)

data = sio.loadmat(f"{file_path}/{person}_TRN_xDAWN.mat")
X = data['X']
Y = data['Y']
X1 = X[Y.flatten() == 1]
X0 = X[Y.flatten() == 0]
...
if __name__ == "__main__":
    ...
    # save the samples
    with open(f'{file_path}/pyro_samples_{person}.pkl', 'wb') as f:
