...
from model_Func import model_single, run_mcmc_single
...
file_path = f'SIM_single/Channel_{channel}/replication_{seed}'
...
if __name__ == "__main__":
    samples = run_mcmc_single(model_single, X1, X0, T, N1, N0, s1, s0, gamma, L_1, L_0, Psi_1, Psi_0, V_Psi_1, V_Psi_0, seed)
