...
file_name = sprintf('E:/MSPH/EEG methodology/Advanced EEG Code/Code for GitHub/SMGP_BCI_EEG/SIM_multi/replication_%d/train_data_L_%d_I_%d_%d.csv', rep, L, I, rep);
...
save_path = sprintf('E:/MSPH/EEG methodology/Advanced EEG Code/Code for GitHub/SMGP_BCI_EEG/SIM_multi/replication_%d/', rep);
