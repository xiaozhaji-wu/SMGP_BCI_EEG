function [b, se, pval, inmodel, stats] = trainSWLDAmatlab(xTr, yTr, maxVar)
...
%   feature_prop: DOUBLE - the proportion of feature selected, ranging from
%   0 to 1.
...
[b, se, pval, inmodel, stats]= ...
    stepwisefit(xTr, yTr, 'penter', pEntry, 'premove', pRemoval, ...
